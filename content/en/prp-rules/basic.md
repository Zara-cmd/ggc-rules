...
Vehicle Deathmatch ist das An- und Überfahren von Spielern mit einem Fahrzeug.
Das An- und Überfahren von Spielern ist nur gestattet, wenn ein Tötungsgrund und eine damit einhergehende Tötung des Spielers auf anderen Wege zulässig gewesen wäre.
Jeder Spieler hat darauf zu achten, dass er keine anderen Spieler verletzt oder tötet. Auch eine versehentliche Tötung aufgrund erhöhter Geschwindigkeit ist unzulässig. Jeder Spieler muss versuchen einen möglichen Schaden anderer zu vermeiden indem er bremst oder ausweicht.

Jede Form der vorsätzlichen Schädigung oder Tötung anderer Spieler ist unzulässig, sofern es keinen Grund regelkonformen Grund gab.

### 3. New Life Rules (NLR)
...
Es ist verboten die Einsatzfahrzeuge der Mediziner zu klauen. Die Einsatzfahrzeuge der Polizei dürfen nur geklaut werden, wenn es einer dringenden Flucht bedarf oder es im Rahmen einer Geiselnahme erfolgt.

### 9. Wohnraum

Der Besitz mehrer Grundstücke und Wohnungen ist erlaubt, wenn diese auch durch den Spieler oder Fraktionsmitgliedern aktiv genutzt werden.
Der Kauf aller Türen die zum Grundstück gehören, ist für jeden Spieler verpflichtend.

Der Kauf von Türen die ein anderer Spieler versehentlich nicht gekauft hat, ist verboten.
